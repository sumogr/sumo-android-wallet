...
import com.m2049r.sumowallet.util.FingerprintHelper;
import com.m2049r.sumowallet.util.Helper;
import com.m2049r.sumowallet.util.KeyStoreHelper;
import com.m2049r.sumowallet.util.RestoreHeight;
import com.m2049r.sumowallet.util.ledger.Monero;
...
public class GenerateFragment extends Fragment {
    ...
    private void checkPassword() {
        ...
        if (!password.isEmpty()) {
            ...
            //etWalletPassword.setDefaultHintTextColor(ColorStateList.valueOf(Color.BLUE));
            if(guessesLog10 < 10 ){
                etWalletPassword.setErrorTextColor(ColorStateList.valueOf(Color.RED));
            }else if(guessesLog10 > 10){
                etWalletPassword.setErrorTextColor(ColorStateList.valueOf(Color.GREEN));
            }
        } else {
